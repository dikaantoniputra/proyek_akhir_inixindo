...
<head>
    <meta charset="utf-8" />
    <title>404 Halaman Tidak Ditemukan | TaskApp</title>
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body p-4 text-center">
                            <div class="text-center">
                                <h1 class="text-error display-3 text-primary fw-bold">404</h1>
                                <h4 class="text-uppercase text-danger mt-3">Halaman Tidak Ditemukan</h4>
                                <p class="text-muted mt-3">
                                    Halaman atau data yang Anda cari tidak tersedia, telah dihapus, atau tautan yang Anda tuju salah.
                                </p>
